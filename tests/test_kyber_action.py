...
# )
def test_kyber_actions(kyber_action):
    value = 1e17
    ...
    kyber_action.tradeEtherToToken(kyber_action, usdc, 1, 0, "")
    ...
    kyber_action.tradeTokenToToken(kyber_action, usdc, dai, 1, 0, "")
    ...
    kyber_action.tradeTokenToEther(accounts[0], dai, 1, 0, "")
