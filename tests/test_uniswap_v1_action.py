...
def test_get_amounts(dai_erc20, uniswap_v1_action, usdc_erc20, weth9_erc20):
    eth_amount = 1e18
    dai_amount = 1e20
    ...
    amounts = uniswap_v1_action.getAmounts(zero_address, eth_amount, dai_erc20)

    print("amounts 1", amounts)
    # TODO: what should we assert?

    # TODO: use amounts from the previous call
    amounts = uniswap_v1_action.getAmounts(dai_erc20, dai_amount, zero_address)
...
def test_action(uniswap_v1_action):
    value = 1e17
    ...
    uniswap_v1_action.tradeEtherToToken(uniswap_v1_action, usdc, 1, 0, "")
    ...
    uniswap_v1_action.tradeTokenToToken(uniswap_v1_action, usdc, dai, 1, 0, "")
    ...
    uniswap_v1_action.tradeTokenToEther(zero_address, dai, 1, 0, "")
