...
contract ArgobytesFactory {
    ...
    function createClone(address target, bytes32 salt) public returns (address clone) {
    ...
    */
    function createClone(
        ...
        assembly {
            ...
            mstore(code, 0x3d604180600a3d3981f3363d3d373d3d3d363d73000000000000000000000000)
    ...
    function createClones(address target, bytes32[] calldata salts) public {
